...
FORMATS: dict[ArtifactKind, FormatSpec] = {
	"data_app": FormatSpec(
		...
		must_have=["KPI strip", "primary table", "filters or search"],
		...
		aesthetic_hint="Interactive explorer — filters, tabs, drill-down when useful.",
	),
	"report": FormatSpec(
		kind="report",
		label="Report",
	...
	"slides": FormatSpec(
		...
		must_have=["title slide", "situation slide", "evidence slides", "closing"],
	...
	"one_pager": FormatSpec(
		...
		must_have=["hero headline", "3–5 KPIs", "priority list", "single print page"],
